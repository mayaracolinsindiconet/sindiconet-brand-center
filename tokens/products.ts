...
export const products = {
  ...
  pro: {
    ...
    colors: {
      ...
      luz:         '#BAA0D6',
      onPrimary:   '#FFFFFF',
      palette:     ['#1D102B', '#3A2156', '#61368F', '#7441AC', '#9771C1', '#BAA0D6', '#F6F0FC'] as const,
      primarias:   ['#7441AC', '#61368F', '#9771C1'] as const,
      secundarias: ['#3A2156', '#251956', '#BAA0D6', '#F6F0FC'] as const,
      destaques:   ['#855DEA', '#B36CFF'] as const,
      gradiente:   { start: '#3A2156', mid: '#7441AC', end: '#BAA0D6' } as const,
    },
  },
