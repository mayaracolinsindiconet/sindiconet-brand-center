...
const CHANNELS: { id: Channel; label: string }[] = [
  ...
  { id: 'comercial',    label: 'Copy comercial' },
]
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-16 py-10">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium border transition-all ${
                  channel === ch.id
                    ...
                    : 'bg-white text-neutral-600 border-neutral-200 hover:border-blue-300 hover:text-blue-700'
                }`}
              >
                {ch.label}
              </button>
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 p-6 mb-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <span className={`text-xs ${overLimit ? 'text-red-600 font-medium' : 'text-neutral-400'}`}>
              {charCount} / 3000 caracteres
            </span>
            {overLimit && (
              <span className="text-xs text-red-600">Reduza o texto para continuar</span>
            )}
          </div>
        </div>
        ...
        <button
          ...
          className="w-full py-3.5 rounded-xl bg-blue-600 text-white font-semibold text-sm
                     hover:bg-blue-700 active:scale-[.99] transition-all
