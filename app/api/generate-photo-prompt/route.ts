...
FOTORREALISMO OBRIGATORIO (prioridade maxima, SEM EXCECOES): TODA imagem gerada, sem excecao, precisa parecer uma fotografia real tirada com camera profissional (DSLR ou mirrorless), NUNCA uma ilustracao, render 3D, arte digital, pintura, cartoon ou algo com "cara de IA". Essa exigencia vale sempre -- independente de qual pilar, estilo ou pilar especial (ex: obra/reforma) seja aplicado, e independente do que a descricao do usuario sugerir; nenhuma regra de estilo, minimalismo ou excecao de pilar jamais reduz ou substitui o fotorrealismo. Descreva sempre: textura de pele natural com poros e imperfeicoes reais, texturas realistas de tecido e materiais, fisica de luz e sombra precisa, profundidade de campo rasa com bokeh autentico, grao de filme sutil. Evite pele plastica/cerosa, superficies excessivamente suavizadas, simetria artificial perfeita, brilho de render 3D ou qualquer aparencia sintetica/gerada por IA.
