...
const proLogos: LogoOption[] = [
  ...
  { key: 'pro-mista-dark',        label: 'Mista · Dark',       src: '/assets/logos/pro/pro-mista-dark.svg',        darkRecommended: false, group: 'mista' },
  { key: 'pro-mista-outline',     label: 'Mista · Outline',    src: '/assets/logos/pro/pro-mista-outline.svg',     darkRecommended: false, group: 'mista' },
  { key: 'pro-simbolo-colorida',  label: 'Símbolo · Colorida', src: '/assets/logos/pro/pro-simbolo-colorida.svg',  darkRecommended: false, alwaysCorrect: true,  group: 'simbolo' },
  { key: 'pro-simbolo-gradient',  label: 'Símbolo · Gradient', src: '/assets/logos/pro/pro-simbolo-gradient.svg',  darkRecommended: false, alwaysCorrect: true,  group: 'simbolo' },
